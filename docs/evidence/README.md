...
| File | Skenario | Hasil |
|---|---|---|
| `acceptance.log` | boot normal, `init` menjalankan 38 uji K01–K03, D01, C01 dan A01 | `ALL TESTS PASSED (38/38)`, exit QEMU 33; termasuk 128 token inferensi yang cocok dengan baseline |
